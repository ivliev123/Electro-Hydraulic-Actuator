...
load(path_data_sim + 'sim_data_5_1.mat', 'data');
sim_data_1 = data;
load(path_data_sim + 'sim_data_5_2.mat', 'data');
sim_data_2 = data;
load(path_data_sim + 'sim_data_5_3.mat', 'data');
sim_data_3 = data;
load(path_data_sim + 'sim_data_5_4.mat', 'data');
sim_data_4 = data;
