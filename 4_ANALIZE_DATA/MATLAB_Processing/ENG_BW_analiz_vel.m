...
nexttile
hold on 
plot(EXP_1_1_Time, EXP_1_1_Velocity, '-r', 'LineWidth', 0.5);
plot(EXP_2_1_Time, EXP_2_1_Velocity, '-g', 'LineWidth', 0.5);
plot(EXP_3_1_Time, EXP_3_1_Velocity, '-b', 'LineWidth', 0.5);
plot(EXP_4_1_Time, EXP_4_1_Velocity, '-m', 'MarkerSize', 3, 'MarkerIndices',1:100:length(EXP_1_4_Velocity), 'LineWidth', 0.5);
% plot(EXP_1_4_Time, EXP_1_4_Velocity, '-ok', 'LineWidth', 0.5);
...
plot(EXP_1_2_Time, EXP_1_2_Velocity, '-r', 'LineWidth', 0.5);
plot(EXP_2_2_Time, EXP_2_2_Velocity, '-g', 'LineWidth', 0.5);
plot(EXP_3_2_Time, EXP_3_2_Velocity, '-b', 'LineWidth', 0.5);
plot(EXP_4_2_Time, EXP_4_2_Velocity, '-m', 'MarkerSize', 3, 'MarkerIndices',1:100:length(EXP_2_4_Velocity), 'LineWidth', 0.5);
% plot(EXP_2_4_Time, EXP_2_4_Velocity, '-ok', 'LineWidth', 0.5);
...
plot(EXP_1_3_Time, EXP_1_3_Velocity, '-r', 'LineWidth', 0.5);
plot(EXP_2_3_Time, EXP_2_3_Velocity, '-g', 'LineWidth', 0.5);
plot(EXP_3_3_Time, EXP_3_3_Velocity, '-b', 'LineWidth', 0.5);
plot(EXP_4_3_Time, EXP_4_3_Velocity, '-m', 'MarkerSize', 3, 'MarkerIndices',1:100:length(EXP_3_4_Velocity), 'LineWidth', 0.5);
% plot(EXP_3_4_Time, EXP_3_4_Velocity, '-ok', 'LineWidth', 0.5);
...
plot(EXP_1_4_Time, EXP_1_4_Velocity, '-r', 'LineWidth', 0.5);
plot(EXP_2_4_Time, EXP_2_4_Velocity, '-g', 'LineWidth', 0.5);
plot(EXP_3_4_Time, EXP_3_4_Velocity, '-b', 'LineWidth', 0.5);
plot(EXP_4_4_Time, EXP_4_4_Velocity, '-m', 'MarkerSize', 3, 'MarkerIndices',1:100:length(EXP_4_4_Velocity), 'LineWidth', 0.5);
% plot(EXP_4_4_Time, EXP_4_4_Velocity, '-ok', 'LineWidth', 0.5);
...
set(gcf, 'Color', 'w')
export_fig ../FIGURE/analiz_vel.png -painters -m3
