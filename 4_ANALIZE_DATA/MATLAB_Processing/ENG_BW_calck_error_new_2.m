...
legend('F_L_o_a_d = 0 N', 'F_L_o_a_d = 4909 N', 'F_L_o_a_d = 7854 N', 'F_L_o_a_d = 9817 N', 'FontSize', 12, 'NumColumns',2);
ylim([0 0.27])
ax = gca;
ax.YAxis(1).Color = 'k';
...
%exportgraphics(gca,'BW_ENG_NEW/calk_error.jpg','Resolution',300)
set(gcf, 'Color', 'w')
export_fig BW_ENG_NEW/calk_error.png -painters -m3
