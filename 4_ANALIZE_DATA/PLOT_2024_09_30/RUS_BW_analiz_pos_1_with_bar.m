...
ylim([-5 60])
ylabel('Координата, мм', 'FontSize', 12, 'Color','k');
...
ylabel('Давление, бар', 'FontSize', 12, 'Color','k');
ylim([0 60])
ax = gca;
ax.YAxis(1).Color = 'k';
ax.YAxis(2).Color = 'k';
...
legend('X_t_a_s_k, мм', 'X_s_i_m, мм', 'X_e_x_p, мм', 'P_A_e_x_p, бар', 'P_B_e_x_p, бар', 'FontSize', 12); 
...
% plot(B_Time_4, B_P_B_4, '-ok', 'MarkerIndices',1:1000:length(B_P_B_4), 'MarkerSize',3, 'LineWidth', 0.5);
ylabel('Давление, бар', 'FontSize', 12, 'Color','k');
ylim([0 60])
ax = gca;
ax.YAxis(1).Color = 'k';
...
%exportgraphics(t,'ЧБ/analiz_pos_1_with_bar.jpg','Resolution',300)
set(gcf, 'Color', 'w')
export_fig ЧБ/analiz_pos_1_with_bar.png -painters -m3
