...
% plot(A_Time4_1, A_PosErr1_4, 'Color',colormap(map(3, :)), 'LineWidth', 0.5);
...
plot(A_Time1_1, A_PosErr1_1, "-square", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr1_1), 'Color',colormap(map_2(1,:)), 'LineWidth', 0.5);
plot(A_Time1_2, A_PosErr1_2, "-o", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr1_2), 'Color',colormap(map_2(2,:)), 'LineWidth', 0.5);
plot(A_Time1_3, A_PosErr1_3, "-*", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr1_3), 'Color',colormap(map_2(3,:)), 'LineWidth', 0.5);
plot(A_Time1_4, A_PosErr1_4, "-x", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr1_4), 'Color',colormap(map_2(4,:)), 'LineWidth', 0.5);


plot(C_Time1_1, C_PosErr1_1, "--square", 'MarkerSize', 3, 'MarkerIndices', Marker_pos_1_1, 'Color',colormap(map_2(5,:)), 'LineWidth', 0.5);
plot(C_Time1_2, C_PosErr1_2, "--o", 'MarkerSize', 3, 'MarkerIndices', Marker_pos_1_2, 'Color',colormap(map_2(6,:)), 'LineWidth', 0.5);
plot(C_Time1_3, C_PosErr1_3, "--*", 'MarkerSize', 4, 'MarkerIndices', Marker_pos_1_3, 'Color',colormap(map_2(7,:)), 'LineWidth', 0.5);
plot(C_Time1_4, C_PosErr1_4, "--x", 'MarkerSize', 4, 'MarkerIndices', Marker_pos_1_4,'Color',colormap(map_2(8,:)), 'LineWidth', 0.5);


xlabel('Time, s', 'FontSize', 12, 'Color','k'); 
ylabel('Error, mm', 'FontSize', 12, 'Color','k');
legend('X_e_x_p = 12.5 mm', 'X_e_x_p = 25 mm', 'X_e_x_p = 37.5 mm', 'X_e_x_p = 50 mm', 'X_s_i_m = 12.5 mm', 'X_s_i_m = 25 mm', 'X_s_i_m = 37.5 mm', 'X_s_i_m = 50 mm', 'FontSize', 12, 'NumColumns',2);
...
nexttile
hold on 
plot(A_Time2_1, A_PosErr2_1, "-square", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr2_1), 'Color',colormap(map_2(1,:)), 'LineWidth', 0.5);
plot(A_Time2_2, A_PosErr2_2, "-o", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr2_2), 'Color',colormap(map_2(2,:)), 'LineWidth', 0.5);
plot(A_Time2_3, A_PosErr2_3, "-*", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr2_3), 'Color',colormap(map_2(3,:)), 'LineWidth', 0.5);
plot(A_Time2_4, A_PosErr2_4, "-x", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr2_4), 'Color',colormap(map_2(4,:)), 'LineWidth', 0.5);


plot(C_Time2_1, C_PosErr2_1, "--square", 'MarkerSize', 3, 'MarkerIndices', Marker_pos_2_1, 'Color',colormap(map_2(5,:)), 'LineWidth', 0.5);
plot(C_Time2_2, C_PosErr2_2, "--o", 'MarkerSize', 3, 'MarkerIndices', Marker_pos_2_2, 'Color',colormap(map_2(6,:)), 'LineWidth', 0.5);
plot(C_Time2_3, C_PosErr2_3, "--*", 'MarkerSize', 4, 'MarkerIndices', Marker_pos_2_3, 'Color',colormap(map_2(7,:)), 'LineWidth', 0.5);
plot(C_Time2_4, C_PosErr2_4, "--x", 'MarkerSize', 4, 'MarkerIndices', Marker_pos_2_4,'Color',colormap(map_2(8,:)), 'LineWidth', 0.5);
...
nexttile
hold on 
plot(A_Time3_1, A_PosErr3_1, "-square", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr3_1), 'Color',colormap(map_2(1,:)), 'LineWidth', 0.5);
plot(A_Time3_2, A_PosErr3_2, "-o", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr3_2), 'Color',colormap(map_2(2,:)), 'LineWidth', 0.5);
plot(A_Time3_3, A_PosErr3_3, "-*", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr3_3), 'Color',colormap(map_2(3,:)), 'LineWidth', 0.5);
plot(A_Time3_4, A_PosErr3_4, "-x", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr3_4), 'Color',colormap(map_2(4,:)), 'LineWidth', 0.5);


plot(C_Time3_1, C_PosErr3_1, "--square", 'MarkerSize', 3, 'MarkerIndices',Marker_pos_3_1, 'Color',colormap(map_2(5,:)), 'LineWidth', 0.5);
plot(C_Time3_2, C_PosErr3_2, "--o", 'MarkerSize', 3, 'MarkerIndices',Marker_pos_3_2, 'Color',colormap(map_2(6,:)), 'LineWidth', 0.5);
plot(C_Time3_3, C_PosErr3_3, "--*", 'MarkerSize', 4, 'MarkerIndices',Marker_pos_3_3, 'Color',colormap(map_2(7,:)), 'LineWidth', 0.5);
plot(C_Time3_4, C_PosErr3_4, "--x", 'MarkerSize', 4, 'MarkerIndices',Marker_pos_3_4,'Color',colormap(map_2(8,:)), 'LineWidth', 0.5);
...
nexttile
hold on 
plot(A_Time4_1, A_PosErr4_1, "-square", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr4_1), 'Color',colormap(map_2(1,:)), 'LineWidth', 0.5);
plot(A_Time4_2, A_PosErr4_2, "-o", 'MarkerSize', 3, 'MarkerIndices',1:200:length(A_PosErr4_2), 'Color',colormap(map_2(2,:)), 'LineWidth', 0.5);
plot(A_Time4_3, A_PosErr4_3, "-*", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr4_3), 'Color',colormap(map_2(3,:)), 'LineWidth', 0.5);
plot(A_Time4_4, A_PosErr4_4, "-x", 'MarkerSize', 4, 'MarkerIndices',1:200:length(A_PosErr4_4), 'Color',colormap(map_2(4,:)), 'LineWidth', 0.5);


plot(C_Time4_1, C_PosErr4_1, "--square", 'MarkerSize', 3, 'MarkerIndices',Marker_pos_4_1, 'Color',colormap(map_2(5,:)), 'LineWidth', 0.5);
plot(C_Time4_2, C_PosErr4_2, "--o", 'MarkerSize', 3, 'MarkerIndices',Marker_pos_4_2, 'Color',colormap(map_2(6,:)), 'LineWidth', 0.5);
plot(C_Time4_3, C_PosErr4_3, "--*", 'MarkerSize', 4, 'MarkerIndices',Marker_pos_4_3, 'Color',colormap(map_2(7,:)), 'LineWidth', 0.5);
plot(C_Time4_4, C_PosErr4_4, "--x", 'MarkerSize', 4, 'MarkerIndices',Marker_pos_4_4,'Color',colormap(map_2(8,:)), 'LineWidth', 0.5);
...
%exportgraphics(t,'BW_ENG_NEW/analiz_pos_error_ALL.jpg','Resolution',300)
set(gcf, 'Color', 'w')
export_fig BW_ENG_NEW/analiz_pos_error_ALL.png -painters -m3
