...
% B_Time_1  = B_1(:,1)*0.0006 + 4.4177 - 6.1261; %2_1
% B_Time_1  = B_1(:,1)*0.0006 + 4.4276 - 6.0764; %2_2
% B_Time_1  = B_1(:,1)*0.0006 +4.41825 - 5.97929; %2_3
% B_Time_1  = B_1(:,1)*0.0006 + 4.4684 - 5.66724; %2_4

% B_Time_1  = B_1(:,1)*0.0006 + 4.4682 - 5.8365; %3_1
% B_Time_1  = B_1(:,1)*0.0006 + 4.41775 - 6.2025; %3_2
% B_Time_1  = B_1(:,1)*0.0006 +4.4590 - 6.09698; %3_3
% B_Time_1  = B_1(:,1)*0.0006 + 4.4282 - 5.81975; %3_4
...
% C_Time   = C(1,:)*1000 + 69; % A_2_1
% C_Time   = C(1,:)*1000 + 81; % A_2_2
% C_Time   = C(1,:)*1000 + 14; % A_2_3
% C_Time   = C(1,:)*1000  + 30; % A_2_4

% C_Time   = C(1,:)*1000 + 28; % A_3_1
% C_Time   = C(1,:)*1000 + 65; % A_3_2
% C_Time   = C(1,:)*1000 + 68; % A_3_3
% C_Time   = C(1,:)*1000 +80; % A_3_4
...
yyaxis right
plot(B_Time_1, B_P_A_1, '--squareb', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_A_1), 'LineWidth', 1);
plot(B_Time_1, B_P_B_1, '--om', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_B_1), 'LineWidth', 1);
ylabel('Pressure, [bar]');
ylim([0 60])
...
yyaxis right
plot(B_Time_2, B_P_A_2, '--squareb', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_A_2), 'LineWidth', 1);
plot(B_Time_2, B_P_B_2, '--om', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_B_2), 'LineWidth', 1);
...
yyaxis right
plot(B_Time_3, B_P_A_3, '--squareb', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_A_3), 'LineWidth', 1);
plot(B_Time_3, B_P_B_3, '--om', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_B_3), 'LineWidth', 1);
...
yyaxis right
plot(B_Time_4, B_P_A_4, '--squareb', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_A_4), 'LineWidth', 1);
plot(B_Time_4, B_P_B_4, '--om', 'MarkerSize', 3, 'MarkerIndices',1:1000:length(B_P_B_4), 'LineWidth', 1);
% plot(B_Time_4, B_P_A_4, '--b', 'LineWidth', 1);
% plot(B_Time_4, B_P_B_4, '--om', 'MarkerIndices',1:1000:length(B_P_B_4), 'MarkerSize',3, 'LineWidth', 1);
ylabel('Pressure, [bar]');
ylim([0 60])
...
exportgraphics(t,'BW_ENG/analiz_pos_1_with_bar.jpg','Resolution',300)