...
B_filename = 'M_OSC_eksp_2_1new.csv';
...
B_filename = 'M_OSC_eksp_2_2new.csv';
B_2 = dlmread(B_filename, ';', 1, 0);
B_Time_2  = B_2(:,1)*0.0006 + 4.4276 - 6.0764; %2_2
B_P_A_2 = B_2(:,2) * k_P_A;
B_P_B_2  = B_2(:,3)* k_P_B;
B_sinchro_2  = B_2(:,4);

B_filename = 'M_OSC_eksp_2_3new.csv';
B_3 = dlmread(B_filename, ';', 1, 0);
B_Time_3  = B_3(:,1)*0.0006 +4.41825 - 5.97929; %2_3
B_P_A_3 = B_3(:,2) * k_P_A;
B_P_B_3  = B_3(:,3)* k_P_B;
B_sinchro_3  = B_3(:,4);

B_filename = 'M_OSC_eksp_2_4new.csv';
B_4 = dlmread(B_filename, ';', 1, 0);
B_Time_4  = B_4(:,1)*0.0006 + 4.4684 - 5.66724; %2_4
B_P_A_4 = B_4(:,2) * k_P_A;
B_P_B_4  = B_4(:,3)* k_P_B;
B_sinchro_4  = B_4(:,4);
...
C_Time_1   = C_1(1,:)*1000 +35; % A_2_1
C_Time_2   = C_2(1,:)*1000 +60; % A_2_2
C_Time_3   = C_3(1,:)*1000 +40; % A_2_3
C_Time_4   = C_4(1,:)*1000 +88; % A_2_4
...
exportgraphics(t,'BW_ENG/analiz_pos_2_with_bar.jpg','Resolution',300)
