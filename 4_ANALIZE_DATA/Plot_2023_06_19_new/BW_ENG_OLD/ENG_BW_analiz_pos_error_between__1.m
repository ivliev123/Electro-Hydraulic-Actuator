...
plot(C_Time4_1, A_PosErr4_1_between, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
plot(C_Time4_2, A_PosErr4_2_between, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
plot(C_Time4_3, A_PosErr4_3_between, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
plot(C_Time4_4, A_PosErr4_4_between, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
% end
% 
% plot(C_Time1_1, A_PosErr1_1_between, '-b', 'LineWidth', 1);
% plot(C_Time1_1, error_array*100, '-r', 'LineWidth', 1);
% plot(C_Time1_1, absolut_error , '--r', 'LineWidth', 1);
% ylabel('Displacement error, [%]');


exportgraphics(t,'BW_ENG/analiz_pos_error_between.jpg','Resolution',300)
