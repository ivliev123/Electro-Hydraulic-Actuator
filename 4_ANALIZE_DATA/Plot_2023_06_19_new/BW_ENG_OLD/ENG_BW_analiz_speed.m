...
plot(A_Time4_1, A_Speed4_1_F, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
MarkerInd = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200];
plot(A_Time4_2, A_Speed4_2_F, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
MarkerInd = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200];
plot(A_Time4_3, A_Speed4_3_F, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
% plot(A_Time4_4, A_Speed4_4_F, '--ok', 'LineWidth', 1);
MarkerInd = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200];
plot(A_Time4_4, A_Speed4_4_F, '--ok', 'MarkerSize', 3, 'MarkerIndices',MarkerInd, 'LineWidth', 1); 
...
exportgraphics(t,'BW_ENG/analiz_speed.jpg','Resolution',300)
