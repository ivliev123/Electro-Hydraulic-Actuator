...
hold on
plot([12.5, 25, 37.5, 50], [dt1_1, dt1_2, dt1_3, dt1_4], '-squareg', 'LineWidth', 1);

plot([12.5, 25, 37.5, 50], [dt2_1, dt2_2, dt2_3, dt2_4], '-or', 'LineWidth', 1);

plot([12.5, 25, 37.5, 50], [dt3_1, dt3_2, dt3_3, dt3_4], '-*b', 'LineWidth', 1);

plot([12.5, 25, 37.5, 50], [dt4_1, dt4_2, dt4_3, dt4_4], '-xk', 'LineWidth', 1);
...
exportgraphics(gca,'BW_ENG/calk_time.jpg','Resolution',300)
