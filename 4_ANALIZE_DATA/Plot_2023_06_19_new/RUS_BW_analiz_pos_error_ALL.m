...
legend('X_e_x_p = 12.5 мм', 'X_e_x_p = 25 мм', 'X_e_x_p = 37.5 мм', 'X_e_x_p = 50 мм', 'X_s_i_m = 12.5 мм', 'X_s_i_m = 25 мм', 'X_s_i_m = 37.5 мм', 'X_s_i_m = 50 мм', 'FontSize', 12, 'NumColumns',2);
...
%exportgraphics(t,'ЧБ/analiz_pos_error_ALL.jpg','Resolution',300)
set(gcf, 'Color', 'w')
export_fig ЧБ/analiz_pos_error_ALL.png -painters -m3
